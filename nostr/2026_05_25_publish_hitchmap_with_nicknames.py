...
hitchmap_with_nicknames = pd.read_csv("hitchmap_with_nicknames.csv")
hitchmap_with_nicknames["datetime"] = pd.to_datetime(
    hitchmap_with_nicknames["datetime"], unit="ms"
)
hitchmap_with_nicknames.rename(columns={"hitchhiker": "nickname"}, inplace=True)


hitchmap = hitchmap.drop(columns=["nickname"], errors="ignore")
hitchmap["_datetime_s"] = hitchmap["datetime"].dt.floor("s")
hitchmap_with_nicknames["_datetime_s"] = hitchmap_with_nicknames["datetime"].dt.floor("s")

hitchmap = hitchmap.merge(
    hitchmap_with_nicknames[["rating", "country", "_datetime_s", "nickname"]],
    on=["rating", "country", "_datetime_s"],
    how="left",
).drop(columns=["_datetime_s"])
